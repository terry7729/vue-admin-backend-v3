<template>
  <div class="select-dialog">
    <el-button type="text" class='btn-dialog' @click="dialogTableVisible = true">选择商家</el-button>

  <el-dialog title="选择商家" :visible.sync="dialogTableVisible"  @open="dialogOpen">
    <el-form :model="formData" ref="formDataRef" :show-message='false' label-suffix='：' label-width="85px" :inline="true" label-position="rigth">
              <el-form-item label="账户名" prop="username">
                <el-input v-model="formData.username" placeholder="请输入商家账户名"></el-input>
              </el-form-item>
              <el-form-item>
